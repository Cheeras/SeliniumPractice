...
public class BrowserFactory {
	...
	public static WebDriver startSession(String browserName,String url)
	{
		...
		{
			System.setProperty("webdriver.chrome.driver", "C:\\Users\\cheeras\\Desktop\\SeleniumJars\\chromedriver_win32\\chromedriver.exe");
			driver=new ChromeDriver();
			driver.manage().window().maximize();
		}else if(browserName.equalsIgnoreCase("Firefox"))
		{
			System.setProperty("webdriver.gecko.driver", "C:\\Users\\cheeras\\Desktop\\SeleniumJars\\geckodriver.exe");
			driver=new FirefoxDriver();
			driver.manage().window().maximize();
			
		}else if(browserName.equalsIgnoreCase("IE"))
		{
			System.setProperty("webdriver.ie.driver", "C:\\Users\\cheeras\\Desktop\\SeleniumJars\\IEDriverServer.exe");
